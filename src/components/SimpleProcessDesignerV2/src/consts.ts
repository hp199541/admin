...
export const CANDIDATE_STRATEGY: DictDataVO[] = [
  ...
  { label: '组织成员', value: CandidateStrategy.DEPT_MEMBER },
  { label: '组织负责人', value: CandidateStrategy.DEPT_LEADER },
  { label: '连续多级组织负责人', value: CandidateStrategy.MULTI_LEVEL_DEPT_LEADER },
  ...
  { label: '发起人组织负责人', value: CandidateStrategy.START_USER_DEPT_LEADER },
  { label: '发起人连续组织负责人', value: CandidateStrategy.START_USER_MULTI_LEVEL_DEPT_LEADER },
  { label: '用户组', value: CandidateStrategy.USER_GROUP },
  { label: '表单内用户字段', value: CandidateStrategy.FORM_USER },
  { label: '表单内组织负责人', value: CandidateStrategy.FORM_DEPT_LEADER },
...
export const MULTI_LEVEL_DEPT: DictDataVO = [
  { label: '第 1 级组织', value: 1 },
  { label: '第 2 级组织', value: 2 },
  { label: '第 3 级组织', value: 3 },
  { label: '第 4 级组织', value: 4 },
  { label: '第 5 级组织', value: 5 },
  { label: '第 6 级组织', value: 6 },
  { label: '第 7 级组织', value: 7 },
  { label: '第 8 级组织', value: 8 },
  { label: '第 9 级组织', value: 9 },
  { label: '第 10 级组织', value: 10 },
  { label: '第 11 级组织', value: 11 },
  { label: '第 12 级组织', value: 12 },
  { label: '第 13 级组织', value: 13 },
  { label: '第 14 级组织', value: 14 },
  { label: '第 15 级组织', value: 15 }
]
